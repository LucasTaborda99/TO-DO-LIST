    ...
    for (let i = 0; i < listaTarefas.length; i++) {
        ...
        <div class="col s12 m6">
          <div class="card blue-grey darken-1">
            ...
            <p>    
            <label>
                <input onclick="tarefaConcluida(${i})" type="checkbox" ${tarefaConcluida}/> 
                <span></span>
            </label>
            </p>    
              <button onclick="excluirTarefa(${i})"> <i class="material-icons">delete</i></button>
            </div>
          </div>
        </div>
      </div>
...
function limpaCadastrotarefa() {
    ...
    document.getElementById('prioridadeTarefa').value = 'prioridade-normal'; 
}